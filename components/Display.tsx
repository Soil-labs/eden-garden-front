    ...
    <section className="pt-20">
      {sortedUpdates.map((update: ProjectUpdate, index: Number) => (
        ...
        >
          ...
          {update.thread && <p className="text-black mb-3"><a className="border border-slate-300 rounded-xl px-1 py-0.5 hover:bg-slate-300 " href={update.thread? update.thread: ""}>Discord Thread</a></p>}
          <div>
